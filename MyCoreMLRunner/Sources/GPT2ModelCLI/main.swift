...
func main(prompt: String, maxLength: Int) async throws {
...
let maxLength: Int = CommandLine.arguments.count > 2 ? Int(CommandLine.arguments[2])! : 100

try! await main(prompt: prompt, maxLength: maxLength)
